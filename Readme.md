...
This mod requires Homm III + Era Wog 3.9 platform.    You should unzip Land of New Towns mod, copy it to Mods folder, and enable it in mod manager. Mod compatible with WOG, ERA Scripts (tested on ERa 3.9.14 (assembly v2.101)). Also work with Human AI mod.   Please disable other mods for compatibility
 ...
 * add emissares (Gods’ Representatives) dwellings on random map generated
 * some improvements
